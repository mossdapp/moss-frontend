      ...
      <div className="py-4 space-y-6 px-2">
        <div className={'space-y-2'}>
          ...
          <div className="flex gap-2">
            <Input placeholder={'input address'} value={address} onChange={(e) => setAddress(e.target.value)} />
            <Button onClick={getTag}>Get Tag</Button>
          </div>
        </div>
        <div className={'space-y-2'}>
          <Label>Tag</Label>
          <Input placeholder={'input tag'} value={tag} onChange={(e) => setTag(e.target.value)} />
        </div>
